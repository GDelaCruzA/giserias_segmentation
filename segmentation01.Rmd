...
class(crops_ngrdi)
plot(crops_ngrdi, col = colores, breaks=intervalos, main = "NGRDI Vegetation Index")
```

```{r}
crops_ngrdi_mat <- matrix(crops_ngrdi@data@values,
            nrow = crops_ngrdi@nrows,
            ncol = crops_ngrdi@ncols, byrow = TRUE)
